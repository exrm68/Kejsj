...
export interface AppSettings {
  botUsername: string;
  channelLink: string;              // Notice bar Telegram link
  headerTelegramLink?: string;      // Header right side Telegram link
  sidebarTelegramLink?: string;     // Sidebar Telegram link
  bannerTelegramLink?: string;      // Banner Telegram link (যদি লাগে)
